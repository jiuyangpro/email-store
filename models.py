...
class Order(models.Model):
    ...
    order_client_ip = models.CharField(max_length=64, blank=True, default="", verbose_name="下单IP")
    buyer_browser_token = models.CharField(max_length=64, blank=True, default="", verbose_name="浏览器标识")
